...
- ✅ **Scanner de QR Code** - Leitura automática de QR Codes de notas fiscais (NF-e)
...
- ✅ **Geração de Relatórios** - Relatórios filtrados por data e categoria
- ✅ **Compartilhamento** - Envie relatórios por email
- ✅ **Exportação de Dados** - Export em formato JSON
...
5. O relatório aparecerá abaixo com:
   - Período filtrado
   - Tabela detalhada com todas as notas
   - Valor total do período

### Compartilhando e Exportando

#### Compartilhar por Email
1. Gere o relatório primeiro
2. Toque em "Compartilhar por Email"
3. Seu cliente de email será aberto com o relatório

#### Exportar Dados
1. Toque em "Exportar Dados (JSON)"
